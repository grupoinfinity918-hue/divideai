    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-lg mx-auto px-4 pt-8 pb-16">
        <div className="card p-5 h-[520px] flex flex-col">
          <h1 className="font-bold text-gray-900 mb-1">Chat da Venda {chat.tripartite && '— Tripartite'}</h1>
              ...
              <div
                ...
                className={`max-w-[80%] rounded-xl px-3 py-2 text-sm ${
                  m.senderType === 'SUPPORT'
                    ? 'self-center bg-pink-soft text-gray-800'
                    : 'self-end bg-pink-neon text-white ml-auto'
                }`}
                style={m.senderType !== 'SUPPORT' ? {} : {}}
              >
